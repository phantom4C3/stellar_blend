...
"[project]/app/(auth)/connect-wallet/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const Auth = ()=>{
    ...
    const { wallet, connectWallet, error: walletError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$stores$2f$walletStore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Auth.useEffect": ()=>{
            const checkWallet = {
                "Auth.useEffect.checkWallet": async ()=>{
                    if (wallet?.address) {
                    // No direct navigation here; handled by handleNavigate
                    }
                }
            }["Auth.useEffect.checkWallet"];
            checkWallet();
        }
    }["Auth.useEffect"], [
        wallet
    ...
    const handleConnectWallet = async ()=>{
        ...
        try {
            await connectWallet();
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Wallet connected successfully!');
            handleNavigate('/');
        } catch  {
            setError(walletError || 'Failed to connect wallet');
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error(`Wallet connection error: ${walletError || 'Unknown error'}`);
        } finally{
            setIsLoading(false);
        }
    };
...
_s(Auth, "NrdHPXdRKM1oiDof7z+JthTkXr4=", false, function() {
    return [
...
//# sourceMappingURL=_e2b7db1e._.js.map